...
public class HttpClientProvider implements DisposableBean {
	...
	protected CloseableHttpClient createHttpClient() {
		return HttpClientBuilder.create().setSslcontext(sslContextProvider.getSSLContext()).setSSLHostnameVerifier(new NoopHostnameVerifier())
				.setUserAgent(config.getHttpUserAgent()).build();
	}
